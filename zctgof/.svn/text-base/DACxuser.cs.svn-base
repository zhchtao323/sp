...
namespace DACX
{
    ...
    {//
        ...
        public void getQxs()
        {
            try
            {
                string str_con = @"Data Source=169.85.170.18;Initial Catalog=LZK;User ID=lzk;pwd=lzk2009~";
        ...
        public bool GetUser(string strName, string strMa)
        {
            ...
            try
            {
                ...
                string str_con = @"Data Source=169.85.170.18;Initial Catalog=LZK;User ID=lzk;pwd=lzk2009~";// "pwd=sjfc_gks{;user id=gks;Initial Catalog=scgl;Data Source=169.85.170.18";
                SqlConnection sqlc = new SqlConnection(str_con);
