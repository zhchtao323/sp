...
{  
    ...
    ///. ms  sql 数据库操作类
    /// </summary>
    public  class MsData :IDisposable, IData //IData,
    {
        ///// <summary>
        ///// Database connection.
        ///// </summary>
        ...
        private SqlTransaction sqlt;
        public MsData(string conn)
        {
        ...
        public void ExecuteNonQuerys(List<String> sql)//没有在接口中
        {
            ...
            {
                SqlCommand sqlcommand = new SqlCommand(Sql1, this.sqlcon, sqltransaction);
        ...
        public void UpdateDs(System.Data.DataTable dt, string selsql)
        {
            ...
            SqlDataAdapter sqld = new SqlDataAdapter(selsql,sqlcon);
