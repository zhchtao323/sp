...
namespace ConceptDevelopment
{
    public static class Kelvin<T> // where T : ISerializable // prevents string[] from being Serialized
    {
        ...
        #region TODO: To/From SqlXml
        /// <summary>
        /// Serialize object to a SqlXml instance for saving to a SqlServer2005 XML column
        /// </summary>
        /// <param name="cryo"></param>
        /// <returns></returns>
        public static System.Data.SqlTypes.SqlXml ToSqlXml(T cryo)
        {
